...
namespace TradplusSDK.iOS
{
    ...
    public class TradplusNativeBanneriOS
    {
        ...
        private static extern void TradplusLoadNativeBannerAd(string adUnitId, bool closeAutoShow, float x, float y, float width, float height, int adPosition, string sceneId, string customMap, string className,string localParams, bool openAutoLoadCallback, float maxWaitTime);
        public void LoadNativeBannerAd(string adUnitId, string sceneId, TPNativeBannerExtra extra)
        {
            ...
            TradplusLoadNativeBannerAd(adUnitId,extra.closeAutoShow,extra.x,extra.y,extra.width,extra.height,(int)extra.adPosition,sceneId, customMapString,extra.className,localParamsString,extra.openAutoLoadCallback,extra.maxWaitTime);
        }
