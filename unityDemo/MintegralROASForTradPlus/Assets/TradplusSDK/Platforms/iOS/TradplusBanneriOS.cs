...
namespace TradplusSDK.iOS
{
    public class TradplusBanneriOS
    {
        ...
        private static extern void TradplusLoadBannerAd(string adUnitId, bool closeAutoShow, float x, float y, float width, float height,int adPosition, int contentMode, string sceneId, string customMap,string className, string localParams, bool openAutoLoadCallback, float maxWaitTime);
        public void LoadBannerAd(string adUnitId, string sceneId , TPBannerExtra extra)
        {
            ...
            TradplusLoadBannerAd(adUnitId, extra.closeAutoShow,extra.x,extra.y,extra.width,extra.height,(int)extra.adPosition, (int)extra.contentMode , sceneId,customMapString, extra.className, localParamsString, extra.openAutoLoadCallback, extra.maxWaitTime);
        }
